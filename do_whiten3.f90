...
sc(1:npts)=dcmplx(dble(sig(1:npts,3)),0.d0)
...
call dfftw_plan_dft_1d(plan,nn,sc,scf,FFTW_FORWARD, FFTW_ESTIMATE)
call dfftw_execute(plan)
call dfftw_destroy_plan(plan)
call smoothf(2,saf,ss1)
call smoothf(2,sbf,ss2)
call smoothf(2,scf,ss3)
do i=1,nk 
